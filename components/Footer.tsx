...
export default function Footer() {
  ...
  return (
    <footer className="footer pt-[30px] pb-10">
      <div className="container mx-auto px-4">
        <div className="footer_content border-b border-border-light pb-10 lg:pb-12 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] gap-10 lg:gap-20">
            ...
            <div className="flex flex-col gap-4 max-w-[300px]">
              ...
              <p className="font-nunito text-base font-medium text-custom m-0">
              ...
              <div className="mt-2">
                <ul className="flex items-center gap-5 p-0 m-0 list-none">
                  <li>
                    <a
                      href="https://x.com/I_Screener"
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Follow us on X (Twitter)"
                      className="text-custom opacity-80 hover:opacity-100 transition-opacity"
                    >
                      <FaXTwitter size={16} />
                    </a>
                  </li>
                  <li>
                    <a
                      href="https://www.linkedin.com/company/interview-screener/"
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  <li>
                    <a
                      href="https://www.instagram.com/interviewscreener/"
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  <li>
                    <a
                      href="https://www.youtube.com/@InterviewScreener"
                      target="_blank"
                      rel="noopener noreferrer"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 lg:gap-12 w-full justify-items-start lg:justify-items-end">
              ...
              <div className="flex flex-col">
                <h3 className="font-nunito text-base font-medium text-custom mb-4">
                  Company
                </h3>
                <a
                  href="#who_we_are"
                  onClick={(e) => handleSectionClick(e, "#who_we_are")}
                  className="font-normal text-small text-custom opacity-80 hover:opacity-100 mb-2.5 transition-opacity flex items-center"
                >
                  What We Do
                </a>
                <a
              ...
              <div className="flex flex-col">
                ...
                <a
                  href="mailto:support@interviewscreener.com"
                  className="font-normal text-small text-custom opacity-80 hover:opacity-100 mb-2.5 transition-opacity flex items-center"
                >
                  Contact Support
                </a>
              ...
              <div className="flex flex-col">
                ...
                <button
                  onClick={scrollToTop}
                  className="cursor-pointer mt-8 lg:mt-12 w-10 h-10 rounded-full bg-linear-to-r from-[#1f1f1f] via-[#161616] to-[#1f1f1f] text-white flex items-center justify-center hover:shadow-lg transition-shadow ml-auto"
