 ...
 * Renders article content blocks with proper formatting
 */
    ...
    switch (block.type) {
      ...
      case 'paragraph':
        return (
          <p
            key={index}
            className="font-nunito text-[17px] leading-[1.8] text-text mb-6"
      ...
      case 'h1':
        return (
          <h1
            key={index}
            className="font-lexend text-4xl sm:text-3xl font-bold text-text mt-12 mb-6 leading-tight"
          >
            {block.content}
          </h1>
        );
      ...
      case 'h2':
        return (
          <h2
            key={index}
            className="font-lexend text-3xl sm:text-2xl font-bold text-text mt-10 mb-4 leading-tight"
          >
            {block.content}
          </h2>
        );
      ...
      case 'h3':
        return (
          <h3
            key={index}
            className="font-lexend text-2xl sm:text-xl font-bold text-text mt-8 mb-4 leading-tight"
          >
            {block.content}
          </h3>
        );
      ...
      case 'heading':
        ...
        const headingSizes: Record<number, string> = {
          2: 'text-3xl sm:text-2xl',
          3: 'text-2xl sm:text-xl',
          4: 'text-xl sm:text-lg',
        };
      ...
      case 'code':
        return (
          <pre
            key={index}
            className="bg-[#1e1e1e] text-[#d4d4d4] p-6 rounded-lg overflow-x-auto mb-6 font-mono text-sm"
          >
