...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description: 'Choose the perfect Interview Screener plan for your team. From $49.99/month with 500 credits. AI-powered resume screening and automated interviews that save time and money.',
  keywords: 'Interview Screener pricing, AI hiring plans, recruitment software pricing, HR automation costs, automated interview pricing',
});
